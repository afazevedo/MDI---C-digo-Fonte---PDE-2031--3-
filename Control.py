...
class Control:
    ...
    def __init__(self, plan_dados, path, time):
        ...
        self.problema = Problema(self.recebe_dados, self.sin, self.isRestPotHabilitada, self.isRestExpJanHabilitada, self.isPerpetHabilitada, self.fatorCarga, self.anoValidadeTemp, self.fatorValidadeTemp, self.isIntercambLimitado, self.subsFic, self.isCustoRestPotHabilitado);
        
        # habilita o cplex
        optsolver = SolverFactory("cplex", executable= "D:\\Arquivos de Programas\\IBM\\ILOG\\CPLEX_Studio129\\cplex\\bin\\x64_win64\\cplex.exe");
        print ("Modelo Criado");
    ...
    def carregaInicio(self):
        ...
        if (self.recebe_dados.pegaEscalar("O11")==1):
        ...
        self.isCustoRestPotHabilitado = False;
        ...
        # verifica se a opcao de expansao apenas em janeiro/julho esta habilitada
        if (self.recebe_dados.pegaEscalar("O3")==1):
            # se o valor da celula for true, o parametro deve indicar que a restricao de expansao somente em janeiro/julho esta habilitada
        ...
        # verifica se a opcao de considerar custos na restricao de potencia esta habilitada
        if (self.recebe_dados.pegaEscalar("O12")==1):
            # se o valor da celula for true, o parametro deve indicar que o calculo da FO deve considerar custos de GT na restricao de potencia
            self.isCustoRestPotHabilitado = True;
